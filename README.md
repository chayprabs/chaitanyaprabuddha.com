...
- **Projects** — LocalYapper (on-device voice dictation), Newsroom (Crustdata-style AI editorial pipeline)
...
- **Achievements** — 2nd at Eightfold AI Hackathon (Apogee Fest 2026), Featured Builder at OpenAI Codex Hackathon, Top 10 at ContextCon, 1st at Solve for Pilani (Apogee Fest 2025), 3rd at BITSpreneur
...
- **Authos** — my current startup: a remote tool platform for coding agents
- **StemLM** — private-beta STEM learning extension for structured AI problem solving
